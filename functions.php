...
function theme_name_scripts() {
  ...
  wp_enqueue_script('fancybox', '//cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js', array('jquery'), '1.0.0', true ); //depends on jquery
...
function flowers_init(){ 
	register_post_type('reviews', array(
		'labels'             => array(
			...
			'singular_name'      => 'Отзыв', // отдельное название записи типа отзыв
	...
	register_post_type('flowers', array(
		'labels'             => array(
			...
			'singular_name'      => 'Букет', // отдельное название записи типа отзыв
			'add_new'            => 'Добавить новый букет',
...
add_action('wp-ajax_form', 'submit_form');
add_action('wp-ajax_nopriv_form', 'submit_form');
